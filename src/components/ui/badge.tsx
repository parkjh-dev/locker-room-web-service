...
const badgeVariants = cva(
  'inline-flex items-center gap-1 rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2',
  {
    variants: {
      variant: {
        default:
          'border-transparent bg-primary text-primary-foreground shadow-xs hover:bg-brand-600',
        ...
        outline: 'border-brand-200 bg-card text-foreground',
        ghost: 'border-transparent bg-foreground/5 text-foreground/80',
      },
    },
    defaultVariants: {
      variant: 'default',
